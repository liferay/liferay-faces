...
public class RendererUtil {
	...
	// Public Constants
	public static final String AUI_END_SCRIPT = "});";
	...
	public static void handleBufferedScript(FacesContext facesContext, UIComponent uiComponent,
		BufferedScriptResponseWriter bufferedScriptResponseWriter, String use) {
		...
		clientScript.append(portletId, bufferedScriptResponseWriter.toString(), use);
	}
	...
	public static String getAUIBeginScript(FacesContext facesContext, String[] modules) {
		return getAUIBeginScript(facesContext, modules, null);
	}

	public static String getAUIBeginScript(String[] modules, float browserMajorVersion, boolean browserIE) {
		return getAUIBeginScript(modules, null, browserMajorVersion, browserIE);
	}

	public static String getAUIBeginScript(FacesContext facesContext, String[] modules, String config) {
		...
		return getAUIBeginScript(modules, config, browserMajorVersion, browserIE);
	}

	public static String getAUIBeginScript(String[] modules, String config, float browserMajorVersion,
		boolean browserIE) {
