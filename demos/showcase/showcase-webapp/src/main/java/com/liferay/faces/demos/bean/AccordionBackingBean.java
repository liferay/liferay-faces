...
import com.liferay.faces.alloy.component.accordion.AccordionTabEvent;
...
public class AccordionBackingBean {
	...
	public void tabEventListener(AccordionTabEvent accordionTabEvent) {
		FacesContext facesContext = FacesContext.getCurrentInstance();
		FacesMessage facesMessage = new FacesMessage(accordionTabEvent.getName() + ": " + accordionTabEvent.getTab().getLabel());
	...
	public AccordionBackingBean() {
		...
		if ("selected-tab".equals(componentUseCase)) {
			FacesMessage facesMessage = new FacesMessage("The default value of selectedIndex=" + getDefaultSelectedIndex());
			facesContext.addMessage(null, facesMessage);
		}
	}
