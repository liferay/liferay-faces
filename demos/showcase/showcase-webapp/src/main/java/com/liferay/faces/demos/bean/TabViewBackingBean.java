...
import com.liferay.faces.alloy.component.tabview.TabViewTabEvent;
...
public class TabViewBackingBean {
	...
	public void tabEventListener(TabViewTabEvent tabViewTabEvent) {
		FacesContext facesContext = FacesContext.getCurrentInstance();
		FacesMessage facesMessage = new FacesMessage(tabViewTabEvent.getName() + ": " + tabViewTabEvent.getTab().getLabel());
