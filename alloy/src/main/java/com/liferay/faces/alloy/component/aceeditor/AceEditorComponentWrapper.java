...
public class AceEditorComponentWrapper implements AceEditorComponent, FacesWrapper<AceEditorComponent> {

	// Private Data Members
	private AceEditorComponent wrappedAceEditorComponent;

	public AceEditorComponentWrapper(AceEditorComponent aceEditorComponent) {
		this.wrappedAceEditorComponent = aceEditorComponent;
	}

	@Override
	public AceEditorComponent getWrapped() {
		return wrappedAceEditorComponent;
	}
	...
	public String getAfterHighlightActiveLineChange() {
		return getWrapped().getAfterHighlightActiveLineChange();
	}

	@Override
	public void setAfterHighlightActiveLineChange(String afterHighlightActiveLineChange) {
		getWrapped().setAfterHighlightActiveLineChange(afterHighlightActiveLineChange);
	}
	...
	public String getAfterModeChange() {
		return getWrapped().getAfterModeChange();
	}

	@Override
	public void setAfterModeChange(String afterModeChange) {
		getWrapped().setAfterModeChange(afterModeChange);
	}

	@Override
	public String getAfterReadOnlyChange() {
		return getWrapped().getAfterReadOnlyChange();
	}

	@Override
	public void setAfterReadOnlyChange(String afterReadOnlyChange) {
		getWrapped().setAfterReadOnlyChange(afterReadOnlyChange);
	}
	...
	public String getAfterShowPrintMarginChange() {
		return getWrapped().getAfterShowPrintMarginChange();
	}

	@Override
	public void setAfterShowPrintMarginChange(String afterShowPrintMarginChange) {
		getWrapped().setAfterShowPrintMarginChange(afterShowPrintMarginChange);
	}
	...
	public String getAfterTabSizeChange() {
		return getWrapped().getAfterTabSizeChange();
	}

	@Override
	public void setAfterTabSizeChange(String afterTabSizeChange) {
		getWrapped().setAfterTabSizeChange(afterTabSizeChange);
	}

	@Override
	public String getAfterUseSoftTabsChange() {
		return getWrapped().getAfterUseSoftTabsChange();
	}

	@Override
	public void setAfterUseSoftTabsChange(String afterUseSoftTabsChange) {
		getWrapped().setAfterUseSoftTabsChange(afterUseSoftTabsChange);
	}

	@Override
	public String getAfterUseWrapModeChange() {
		return getWrapped().getAfterUseWrapModeChange();
	}

	@Override
	public void setAfterUseWrapModeChange(String afterUseWrapModeChange) {
		getWrapped().setAfterUseWrapModeChange(afterUseWrapModeChange);
	}
	...
	public Boolean isHighlightActiveLine() {
		return getWrapped().isHighlightActiveLine();
	}
	...
	public String getMode() {
		return getWrapped().getMode();
	}

	@Override
	public void setMode(String mode) {
		getWrapped().setMode(mode);
	}
	...
	public String getOnHighlightActiveLineChange() {
		return getWrapped().getOnHighlightActiveLineChange();
	}

	@Override
	public void setOnHighlightActiveLineChange(String onHighlightActiveLineChange) {
		getWrapped().setOnHighlightActiveLineChange(onHighlightActiveLineChange);
	}
	...
	public String getOnModeChange() {
		return getWrapped().getOnModeChange();
	}

	@Override
	public void setOnModeChange(String onModeChange) {
		getWrapped().setOnModeChange(onModeChange);
	}

	@Override
	public String getOnReadOnlyChange() {
		return getWrapped().getOnReadOnlyChange();
	}

	@Override
	public void setOnReadOnlyChange(String onReadOnlyChange) {
		getWrapped().setOnReadOnlyChange(onReadOnlyChange);
	}
	...
	public String getOnShowPrintMarginChange() {
		return getWrapped().getOnShowPrintMarginChange();
	}

	@Override
	public void setOnShowPrintMarginChange(String onShowPrintMarginChange) {
		getWrapped().setOnShowPrintMarginChange(onShowPrintMarginChange);
	}
	...
	public String getOnTabSizeChange() {
		return getWrapped().getOnTabSizeChange();
	}

	@Override
	public void setOnTabSizeChange(String onTabSizeChange) {
		getWrapped().setOnTabSizeChange(onTabSizeChange);
	}

	@Override
	public String getOnUseSoftTabsChange() {
		return getWrapped().getOnUseSoftTabsChange();
	}

	@Override
	public void setOnUseSoftTabsChange(String onUseSoftTabsChange) {
		getWrapped().setOnUseSoftTabsChange(onUseSoftTabsChange);
	}

	@Override
	public String getOnUseWrapModeChange() {
		return getWrapped().getOnUseWrapModeChange();
	}

	@Override
	public void setOnUseWrapModeChange(String onUseWrapModeChange) {
		getWrapped().setOnUseWrapModeChange(onUseWrapModeChange);
	}
	...
	public Boolean isShowPrintMargin() {
		return getWrapped().isShowPrintMargin();
	}

	@Override
	public void setShowPrintMargin(Boolean showPrintMargin) {
		getWrapped().setShowPrintMargin(showPrintMargin);
	}
	...
	public Object getTabSize() {
		return getWrapped().getTabSize();
	}

	@Override
	public void setTabSize(Object tabSize) {
		getWrapped().setTabSize(tabSize);
	}

	@Override
	public Boolean isUseSoftTabs() {
		return getWrapped().isUseSoftTabs();
	}

	@Override
	public void setUseSoftTabs(Boolean useSoftTabs) {
		getWrapped().setUseSoftTabs(useSoftTabs);
	}

	@Override
	public Boolean isUseWrapMode() {
		return getWrapped().isUseWrapMode();
	}

	@Override
	public void setUseWrapMode(Boolean useWrapMode) {
		getWrapped().setUseWrapMode(useWrapMode);
	}
