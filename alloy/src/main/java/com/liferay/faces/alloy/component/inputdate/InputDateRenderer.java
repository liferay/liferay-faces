...
public class InputDateRenderer extends InputDateTimeRendererBase {
	...
	protected void encodePicker(FacesContext facesContext, UIComponent uiComponent, Application application,
		...
		Object locale = inputDate.getLocale();
		...
		Object panes = inputDate.getPanes();

		datePicker.setPanes(panes);

		String styleClass = inputDate.getStyleClass();

		datePicker.setStyleClass(styleClass);

		Object zIndex = inputDate.getzIndex();
