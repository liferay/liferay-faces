...
public abstract class OverlayRendererBase extends DelegatingAlloyRendererBase {
	...
	public void encodeJavaScriptCustom(FacesContext facesContext, UIComponent uiComponent) throws IOException {
		...
		if (forClientId == null) {
			...
			String escapedForClientId = RendererUtil.escapeClientId(StringPool.POUND + forClientId);
		...
		String escapedContentBoxId = RendererUtil.escapeClientId(StringPool.POUND + clientId);
