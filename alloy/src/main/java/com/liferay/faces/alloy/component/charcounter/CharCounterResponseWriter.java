 ...
 */
public class CharCounterResponseWriter extends ResponseWriterWrapper {
	...
	public CharCounterResponseWriter(ResponseWriter responseWriter, UIComponent uiComponent, String counterInnerSpanId,
