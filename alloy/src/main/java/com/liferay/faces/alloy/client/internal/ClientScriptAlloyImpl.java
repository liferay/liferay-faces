 ...
 * @author  Neil Griffin
 */
public class ClientScriptAlloyImpl implements ClientScript {
	...
	@Override
	public void append(String content, String modules) {
		...
		if ((modules == null) || (modules.trim().length() == 0)) {
			...
			String[] useArray = modules.split(StringPool.COMMA);
	...
	public String toString() {
		...
		if (alloyJavaScript.length() > 0) {
			...
			String alloyBeginScript = AlloyClientScriptUtil.getAlloyBeginScript(facesContext, useSet.toArray(useArray));
