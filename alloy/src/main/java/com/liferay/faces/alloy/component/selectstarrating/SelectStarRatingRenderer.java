...
public class SelectStarRatingRenderer extends SelectStarRatingRendererBase {
	...
	public void encodeJavaScriptCustom(FacesContext facesContext, UIComponent uiComponent) throws IOException {
		...
		// Escape the escapedClientId's backslashes becuase it is going to be used as an argument to the regex
		// replacement below.
		String escapedEscapedClientId = escapedClientId.replace(StringPool.BACK_SLASH, DOUBLE_BACKSLASH);
		String hiddenInputNodeJs = "document.getElementsByName('" + escapedEscapedClientId + "')[0]";
