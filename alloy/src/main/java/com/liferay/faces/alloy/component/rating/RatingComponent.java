...
public interface RatingComponent {
	...
	public static final String HIDE_NO_SELECTION_OPTION = "hideNoSelectionOption";
	...
	public static final String WIDGET_CONVERTER_MESSAGE = "converterMessage";
	public static final String WIDGET_IMMEDIATE = "immediate";
	public static final String WIDGET_LANG = "lang";
	public static final String WIDGET_RENDER = "render";
	public static final String WIDGET_REQUIRED = "required";
	public static final String WIDGET_REQUIRED_MESSAGE = "requiredMessage";
	public static final String WIDGET_STYLE_CLASS = "styleClass";
	public static final String WIDGET_VALIDATOR = "validator";
	public static final String WIDGET_VALIDATOR_MESSAGE = "validatorMessage";
	public static final String WIDGET_VALUE_CHANGE_LISTENER = "valueChangeListener";
