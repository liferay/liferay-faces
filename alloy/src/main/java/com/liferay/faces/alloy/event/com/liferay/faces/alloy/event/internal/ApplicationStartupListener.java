 ...
 * details.
 */
package com.liferay.faces.alloy.event.com.liferay.faces.alloy.event.internal;
...
public class ApplicationStartupListener implements SystemEventListener {
	...
	public void processEvent(SystemEvent systemEvent) throws AbortProcessingException {
		...
		if (systemEvent instanceof PostConstructApplicationEvent) {
			...
			MessageContextAlloyImpl messageContextAlloyImpl = new MessageContextAlloyImpl(messageContext);
			MessageContext.setInstance(messageContextAlloyImpl);
		}
	}
