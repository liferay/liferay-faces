...
public class TabView extends TabViewBase implements ClientBehaviorHolder {
	...
	public void addClientBehavior(String eventName, ClientBehavior clientBehavior) {
		...
		// child tag. Register an TabViewBehaviorListener that can respond to the Ajax behavior by invoking the
	...
	public void queueEvent(FacesEvent facesEvent) {
		...
		if (facesEvent instanceof AjaxBehaviorEvent) {
			...
			TabViewTabEvent tabEvent = new TabViewTabEvent(this, behavior, eventName, tab, rowData);
	...
	public String getDefaultEventName() {
		return TabViewTabEvent.TAB_SELECTED;
	}
