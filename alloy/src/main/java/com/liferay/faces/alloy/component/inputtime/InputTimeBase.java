...
public abstract class InputTimeBase extends InputDateTime implements Styleable, ClientComponent {
	...
	public String getMaxTime() {
		return (String) getStateHelper().eval(InputTimePropertyKeys.maxTime, null);
	}
	...
	public String getMinTime() {
		return (String) getStateHelper().eval(InputTimePropertyKeys.minTime, null);
	}
	...
	public String getTimePattern() {
		return (String) getStateHelper().eval(InputTimePropertyKeys.timePattern, null);
	}
