...
public class FACES1638PortletTest extends TesterBase {
	...
	private static final String firstByItemNameXpath =
		"//a[contains(@href,'portlet_First-Item') and text()='First-Item']";
	private static final String secondByItemNameXpath =
		"//a[contains(@href,'portlet_Second-Item') and text()='Second-Item']";
	private static final String thirdByItemNameXpath =
		"//a[contains(@href,'portlet_Third-Item') and text()='Third-Item']";
