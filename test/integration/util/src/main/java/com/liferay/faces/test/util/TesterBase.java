...
public class TesterBase {
	...
	private static final String signedInTextXpath = "//div[@class='portlet-body' and contains(text(), 'You are signed in as')]";
	...
	static final String signInUrl = "http://localhost:8080/";
