...
public class Icefaces3DirectoryPortletTest extends TesterBase {
	...
	private static final String lastNameSearchInputXpath =
		"//label[@class='control-label' and contains(text(), 'Last Name')]/following-sibling::input[contains(@class, 'iceInpTxt')]";
	private static final String firstNameSearchInputXpath =
		"//label[@class='control-label' and contains(text(), 'First Name')]/following-sibling::input[contains(@class, 'iceInpTxt')]";
	private static final String emailAddressSearchInputXpath =
		"//label[@class='control-label' and contains(text(), 'Email Address')]/following-sibling::input[contains(@class, 'iceInpTxt')]";
