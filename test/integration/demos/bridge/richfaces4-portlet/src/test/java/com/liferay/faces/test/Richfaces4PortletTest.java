...
public class Richfaces4PortletTest extends TesterBase {
	...
	private static final String emailAddressFieldErrorXpath =
		"//input[contains(@id,':emailAddress')]/following-sibling::*[1]/child::node()[1]/child::node()[1]";
	...
	private static final String dateOfBirthFieldErrorXpath =
		"//div[contains(@id,':dateOfBirthField')]/span/span[contains(@id,':dateOfBirth')]/span";
	...
	public void commentsFunctioning() throws Exception {
		...
		assertTrue("count of tags when Hide link is showing(" + tags +
			") and count of tags for textarea when showing(" + tagsWhileShowing + ") should be equal",
			tags == tagsWhileShowing);
		...
		logger.log(Level.INFO, "tags = " + tags);
		assertTrue("no textarea should be showing at this point.  Tags counted at this pint(" + tags +
			") should equal tags neeeded to be in the DOM when the textarea is hidden(" + tagsWhileHidden + ")",
			tags == tagsWhileHidden);
...
//      Thread.sleep(50);
	...
	public void fileUpload() throws Exception {
		...
		// submitFileXpath
		logger.log(Level.INFO,
			" submitFileXpath tagName = " + browser.findElement(By.xpath(submitFileXpath)).getTagName());
		logger.log(Level.INFO,
			" submitFileXpath type = " + browser.findElement(By.xpath(submitFileXpath)).getAttribute("type"));
