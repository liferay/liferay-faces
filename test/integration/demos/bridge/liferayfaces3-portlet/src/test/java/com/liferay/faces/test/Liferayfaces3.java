 ...
 */
public class Liferayfaces3 extends TesterBase {

	protected static final Logger logger = Logger.getLogger(Liferayfaces3.class.getName());
	...
	// <a class="dropdown-toggle direction-down max-display-items-15" href="javascript:;" id="_1_WAR_liferayfaces3portlet_INSTANCE_ABCD_kldx_menu" title="Options">
