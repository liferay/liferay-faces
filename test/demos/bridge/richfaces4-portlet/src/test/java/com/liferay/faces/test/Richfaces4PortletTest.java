...
public class Richfaces4PortletTest {
	
	// private static final Logger logger;
	private final static Logger logger = Logger.getLogger(Richfaces4PortletTest.class.getName());
	...
	@FindBy(xpath = "//a[contains(@id,'richfaces4portlet') and contains(@id,'menuButton')]")
	private WebElement menuButton;
	@FindBy(xpath = "//a[contains(@id,'richfaces4portlet') and contains(@id,'menu_preferences')]")
	...
	// <span class="rf-fu-btn-cnt-upl" style="padding: 3px 5px 3px 21px; background-position: 2px 2px;" id="aui_3_4_0_1_1361">Upload</span>
	...
	// <em id="aui_3_4_0_1_1392">RichFaces 4.2.0.Final</em>
	// //ul/li/em[contains(text(),'RichFaces 4.2.0.Final')]
	@FindBy(xpath = "//ul/li/em[contains(text(),'RichFaces')]")
	...
	public void jobApplicant() throws Exception {
		...
		int foo = 0;
		while (!browser.getTitle().contains("RICH4") && foo < 10) {
		...
		assertTrue("submitFilesButton is NOT displayed()", !submitFilesButton.isDisplayed()); // does not show until files are chosen
		...
		assertTrue("richFacesVersion.isDisplayed()", richFacesVersion.isDisplayed());
		...
		logger.log(Level.INFO, richFacesVersion.getText());
