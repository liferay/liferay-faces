...
public class Jsf2CdiPortletTest {
	
	private final static Logger logger = Logger.getLogger(Jsf2CdiPortletTest.class.getName());
	
	// @ArquillianResource
	// URL portalURL;
	String signInUrl = "http://localhost:8080/web/guest/jsf2-sign-in";
	String url = "http://localhost:8080/group/bridge-demos/jsf2-cdi";
