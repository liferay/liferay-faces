...
public class Jsf2PortletTest {
	...
	private static final String submitFilesButtonXpath = "//form[@enctype='multipart/form-data']/input[@type='submit' and @value='Submit']";
...
//		logger.log(Level.INFO, "browser.manage().deleteAllCookies() ...");
	...
	public void dateValidation() throws Exception {
		...
		tags = browser.findElements(By.xpath("//input[contains(@id,':dateOfBirth')]/../child::node()")).size()-1;
		logger.log(Level.INFO, "tags = " + tags);
