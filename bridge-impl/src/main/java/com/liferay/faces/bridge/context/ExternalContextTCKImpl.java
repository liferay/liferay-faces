...
public class ExternalContextTCKImpl extends ExternalContextWrapper {
	...
	public Object getResponse() {
		...
		if ((expectingPortletResponse) && (response instanceof HttpServletResponse)) {
			...
			// BridgeWriteBehindResponseMimeImpl} class-level JavaDoc, with JSF2 it is possible to have the JSF
			// implementation (Mojarra or MyFaces) handle the entire interleaving process by itself. In order to get the
