...
public abstract class BridgeContextFactory implements FactoryWrapper<BridgeContextFactory> {
	...
	public abstract BridgeContext getBridgeContext(BridgeConfig bridgeConfig, PortletConfig portletConfig,
		PortletContext portletContext, PortletRequest portletRequest, PortletResponse portletResponse,
		Bridge.PortletPhase portletPhase) throws FacesException;
}
