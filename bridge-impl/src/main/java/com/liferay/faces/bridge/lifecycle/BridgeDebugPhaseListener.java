 ...
 * @author  Neil Griffin
 */
public class BridgeDebugPhaseListener implements PhaseListener {

	// serialVersionUID
	private static final long serialVersionUID = 5431973221176870776L;

	// Logger
	private static final Logger logger = LoggerFactory.getLogger(BridgeDebugPhaseListener.class);
